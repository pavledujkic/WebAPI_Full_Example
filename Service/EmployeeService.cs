...
internal sealed class EmployeeService : IEmployeeService
{
    ...
    public async Task<IEnumerable<EmployeeDto>> GetEmployeesAsync(Guid companyId, bool trackChanges)
    {
        ...
        var employeesFromDb = await
            _repository.Employee.GetEmployeesAsync(companyId, null, trackChanges);
    ...
    public async Task<EmployeeDto> CreateEmployeeForCompany(Guid companyId, EmployeeForCreationDto employeeForCreation,
        bool trackChanges)
    {
        Company? company = await _repository.Company.GetCompanyAsync(companyId, trackChanges);
    ...
    public async Task DeleteEmployeeForCompanyAsync(Guid companyId, Guid id, bool trackChanges)
    {
        ...
        Employee? employeeForCompany = await
            _repository.Employee.GetEmployeeAsync(companyId, id, trackChanges);
            ...
            employeeForUpdate, bool compTrackChanges, bool empTrackChanges)
    {
        ...
        Employee? employeeEntity = await 
            _repository.Employee.GetEmployeeAsync(companyId, id, empTrackChanges);
    ...
    public Task SaveChangesForPatchAsync(EmployeeForUpdateDto employeeToPatch, Employee 
        employeeEntity)
    {
